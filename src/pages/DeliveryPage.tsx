    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Suqafuran Delivery</h1>
                    <p className="text-gray-500 mt-1">Track your orders and shipping status in real-time.</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden min-h-[400px]">
                ...
                <div className="divide-y divide-gray-50">
                    {isLoading ? (
                        <div className="p-20 text-center text-gray-400">Loading delivery data...</div>
                        ...
                        <div className="p-20 text-center">
                            ...
                            <p className="text-gray-500 mt-2 max-w-xs mx-auto">Items you buy or sell with Suqafuran Delivery will appear here.</p>
                        </div>
                    ) : (
