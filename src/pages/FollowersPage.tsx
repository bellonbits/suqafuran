        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage users who follow your marketplace updates.</p>
                </div>
            </div>

            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden min-h-[400px]">
                <div className="p-6 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                    <h3 className="font-bold text-gray-900">Total Followers ({followers?.length || 0})</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                    {isLoading ? (
                        <div className="col-span-full py-20 text-center text-gray-400">Loading followers...</div>
                        ...
                        <div className="col-span-full py-20 text-center">
                            ...
                            <p className="text-gray-500 mt-2 max-w-xs mx-auto">Build your audience by posting great ads and being active.</p>
                        </div>
                    ) : (
                        followers.map((f) => (
                            <div key={f.id} className="flex items-center gap-4 bg-gray-50/50 p-4 rounded-2xl border border-gray-100 group hover:border-primary-200 transition-all">
                                ...
                                <Button size="sm" variant="outline" className="rounded-lg h-8 text-[10px] font-bold uppercase tracking-tight">Profile</Button>
                            </div>
                        ))
                    )}
                </div>
