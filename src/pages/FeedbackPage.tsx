        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">See what buyers and sellers are saying about you.</p>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm text-center">
                    <p className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-2">Average Rating</p>
                    <div className="flex items-center justify-center gap-1 mb-2">
                        <span className="text-5xl font-black text-gray-900">{averageRating}</span>
                        <Star className="h-8 w-8 text-yellow-500 fill-yellow-500" />
                    </div>
                    <p className="text-xs text-gray-500">Based on {feedback?.length || 0} reviews</p>
                </div>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden min-h-[400px]">
                ...
                <div className="divide-y divide-gray-50">
                    {isLoading ? (
                        <div className="p-20 text-center text-gray-400">Loading reviews...</div>
                        ...
                        <div className="p-20 text-center">
                            ...
                            <p className="text-gray-500 mt-2 max-w-xs mx-auto">Complete transactions to build your reputation on Suqafuran.</p>
                        </div>
                    ) : (
                        feedback.map((f) => (
