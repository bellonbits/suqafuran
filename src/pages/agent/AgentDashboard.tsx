    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 flex items-center gap-3">
                        ...
                        {t('agent.commandCenter')}
                    </h1>
                    <p className="text-gray-500 text-sm mt-1">{t('agent.commandCenterDesc')}</p>
                </div>
                {/* Live indicator */}
            ...
            <div className="flex bg-gray-100 p-1 rounded-xl border border-gray-200 overflow-x-auto mb-8 w-fit">
                {[
                    { id: 'queue', label: t('agent.paymentQueue'), icon: CreditCard, count: queue?.length },
                    { id: 'orders', label: t('agent.pendingOrders'), icon: Clock, count: orders?.filter((o: any) => o.status === 'pending').length },
                    { id: 'history', label: t('agent.history'), icon: CheckCircle },
                ].map((tab) => (
                    <button
                        key={tab.id}
                    ...
                    {activeTab === 'queue' ? (
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="p-6 border-b border-gray-50 flex items-center justify-between">
                                <h3 className="font-bold text-gray-900">{t('agent.incomingPayments')}</h3>
                            ...
                            <div className="divide-y divide-gray-50">
                                {queueLoading ? (
                                    ...
                                    <div className="p-20 text-center">
                                        ...
                                        <p className="text-sm font-black text-gray-300 uppercase tracking-widest">{t('agent.noUnmatchedPayments')}</p>
                                    </div>
                                ) : (
                                    queue?.map((tx: any) => (
                                        <div key={tx.id} className="p-4 hover:bg-gray-50 transition-colors flex items-center justify-between group">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        if (window.confirm(t('agent.rejectConfirm'))) {
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="p-6 border-b border-gray-50 flex items-center justify-between">
                                <h3 className="font-bold text-gray-900">{t('agent.verificationQueue')}</h3>
                            ...
                            <div className="divide-y divide-gray-50">
                                {ordersLoading ? (
                                    ...
                                    <div className="p-20 text-center">
                                        ...
                                        <p className="text-sm font-black text-gray-300 uppercase tracking-widest">{t('agent.noPendingOrders')}</p>
                                    </div>
                                ) : (
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="p-6 border-b border-gray-50 flex items-center justify-between">
                                <h3 className="font-bold text-gray-900">{t('agent.activationHistory')}</h3>
                            ...
                            <div className="divide-y divide-gray-50">
                                {historyLoading ? (
                                    ...
                                    <div className="p-20 text-center text-gray-400">{t('agent.noHistoryFound')}</div>
                                ) : (
                ...
                <div className="space-y-6">
                        ...
                        {selectedOrder ? (
                            ...
                            >
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div>
                                        <label className="text-[10px] uppercase font-bold opacity-60 mb-2 block">{t('agent.linkToPendingOrder')}</label>
                                        <select
                    ...
                    <div className="bg-gray-900 rounded-3xl p-6 text-white overflow-hidden relative">
                        ...
                        <div className="space-y-3 max-h-[400px] overflow-y-auto scrollbar-hide">
                            {logsLoading ? (
                                <div className="text-center py-8 text-gray-600 text-xs">{t('agent.loadingActivity')}</div>
