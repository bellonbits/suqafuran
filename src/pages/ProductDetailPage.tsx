...
import {
    Phone, MessageSquare, Heart, Share2,
...
const ProductDetailPage: React.FC = () => {
    ...
    const mockAd = MOCK_LISTINGS.find(l => l.id === Number(adId)) as unknown as Listing;
    const displayAd = ad || mockAd;
    ...
    const displayRelatedAds = (relatedAds && relatedAds.length > 0)
        ? relatedAds
        : (MOCK_LISTINGS as unknown as Listing[]).filter(l => l.id !== Number(adId));
                        ...
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Button
                                        variant="secondary"
                                        className="w-full gap-2 text-lg h-14 rounded-xl"
                                        onClick={() => navigate(`/messages?user=${displayAd.owner_id}&listing=${displayAd.id}`)}
                                    >
                                    ...
                                    <a
                                        ...
                                        className="w-full inline-flex items-center justify-center h-12 rounded-xl border border-gray-200 text-sm font-bold hover:bg-gray-50 transition-colors"
                                    >
