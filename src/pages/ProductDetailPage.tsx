                ...
                <div className="bg-white px-4 pb-5 flex gap-2 border-b border-gray-100">
                    {!ad ? (
                        ...
                        <>
                            ...
                            <Link
                                to={`/messages?userId=${ad.owner_id}&listing=${ad.id}`}
                    ...
                    <div className="bg-white mt-2 px-4 py-4 border-b border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                            {[t('listing.makeOfferMsg'), t('listing.isAvailable'), t('listing.lastPrice')].map(msg => (
                                <Link
                                    key={msg}
                                    to={`/messages?userId=${ad.owner_id}&listing=${ad.id}&msg=${encodeURIComponent(msg)}`}
                                ...
                                <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                                    ...
                                    {ad && (
                                        <div className="mt-4 pt-4 border-t border-gray-100">
                                            <Link to={`/messages?userId=${ad.owner_id}&listing=${ad.id}&msg=${encodeURIComponent(t('listing.makeOfferMsg'))}`}
