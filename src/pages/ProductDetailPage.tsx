...
const ProductDetailPage: React.FC = () => {
    ...
    const whatsappUrl = `https://wa.me/${ad?.owner?.phone?.replace(/\D/g, '')}?text=${encodeURIComponent(`Hi, I'm interested in: ${displayTitle ?? ''}`)}`;
                        ...
                        <div className="flex-1 min-w-0 space-y-4">
                            ...
                            <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
                                <div className="relative bg-gray-100" style={{ aspectRatio: '16/9' }}>
                                    <img src={getImageUrl(images[activeImage])} alt={displayTitle ?? ''} className="w-full h-full object-contain" />
                                    {images.length > 1 && (
                                        <>
                            ...
                            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                                ...
                                {ad && (
                                    <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                                        ...
                                        <a href={`https://wa.me/?text=${encodeURIComponent((displayTitle || '') + ' ' + window.location.href)}`} target="_blank" rel="noopener noreferrer"
