...
export default function ShopDetailPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                setLoading(true);
                // 1. Fetch categories and target public shop in parallel
                const [categoriesData, shopsData] = await Promise.all([
                    listingsService.getCategories(),
                    listingsService.getShops({ shop_id: shopId, limit: 1 }),
                ]);
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4">
                ...
                <div className="relative bg-gray-200 dark:bg-slate-800 h-44 rounded-xl overflow-hidden mb-6 shadow-sm border border-gray-100 dark:border-slate-800">
                    {bannerImage && (
                        <>
                            <img src={bannerImage} alt={shopName} className="w-full h-full object-cover" />
