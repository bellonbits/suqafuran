                            ...
                            {locationLoading ? (
                                ...
                                <div className="relative bg-gray-100 dark:bg-slate-800 rounded-lg h-80 mb-6 overflow-hidden border-2 border-orange-200 dark:border-orange-900">
                                    <iframe
                                        ...
                                        src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&q=${encodeURIComponent(deliveryAddress || 'Nairobi, Kenya')}&zoom=15`}
                                    />
