...
import { Send, CheckCheck, Phone, Video, Search, MessageSquare, AlertCircle, ShoppingBag } from 'lucide-react';
...
function MessagesPageContent() {
    ...
    useEffect(() => {
        setContacts([
            ...
            {
                id: 106,
                name: 'Halima Express Foods',
                avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200&auto=format&fit=crop',
                lastMessage: 'Your order for Pizza is being prepared. ETA 20 mins!',
                time: 'Yesterday',
                unreadCount: 0,
                isOnline: false
            },
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 h-[calc(100vh-8rem)]">
            <div className="h-full rounded-[32px] overflow-hidden bg-white border border-gray-100 shadow-2xl dark:bg-slate-900 dark:border-slate-800 flex">
                ...
                <aside className="w-full md:w-80 shrink-0 border-r border-gray-100 dark:border-slate-800 flex flex-col h-full bg-slate-50/50 dark:bg-slate-950/20">
