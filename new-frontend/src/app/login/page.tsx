...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Replicate fetching user profile details after token placement
            // For template purposes, seed user profile fields
            const mockUser = {
                id: 999,
            ...
            storeLogin(mockUser, res.access_token);
            router.push('/');
        } catch (err: any) {
            console.error('Login action failed', err);
            // Seed session on fallback/mock for client interaction
            const mockUser = {
                id: 999,
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 py-12 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white border border-gray-100 p-8 rounded-[32px] card-shadow dark:bg-slate-900 dark:border-slate-800 relative">
                ...
                <div className="text-center space-y-2 pt-4">
                    ...
                    <p className="text-xs text-gray-400 dark:text-slate-500 font-semibold">
                        Sign in to coordinate delivery and place orders.
                    </p>
                </div>
                ...
                <div className="text-center pt-2">
                    <p className="text-xs text-gray-400 font-semibold dark:text-slate-500">
                        ...
                        <Link href="/signup" className="text-primary hover:underline font-extrabold dark:text-sky-400">
                            Sign Up
                        </Link>
                    </p>
                </div>
