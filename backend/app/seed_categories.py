...
CATEGORIES = [
    ...
    {
        "name": "Qurxinta & Caafimaadka (Beauty & Personal Care)",
        "slug": "health-beauty",
        "icon_name": "heart",
        "subcategories": [
            {"name": "Timaha (Hair Beauty)", "subs": ["Wigs & Extensions", "Hair Products", "Hair Tools", "Natural Hair Care", "Hair Colour"]},
            {"name": "Daryeelka Wajiga (Face Care)", "subs": ["Foundation", "Moisturizers", "Sunscreen", "Face Wash", "Toners"]},
            {"name": "Daryeelka Afka (Oral Care)", "subs": ["Toothbrush", "Toothpaste", "Mouthwash", "Teeth Whitening", "Dental Floss"]},
            {"name": "Daryeelka Jirka (Body Care)", "subs": ["Lotions & Creams", "Soaps", "Deodorants", "Bath Products", "Shaving"]},
            {"name": "Udgoonka (Fragrance)", "subs": ["Men's Perfume", "Women's Perfume", "Oud & Bakhur", "Body Spray", "Attar"]},
            {"name": "Qurxinta Wajiga (Makeup)", "subs": ["Lipstick", "Eye Makeup", "Foundation", "Blush & Highlighter", "Nail Polish"]},
            {"name": "Qalab & Agab (Tools & Accessories)", "subs": ["Makeup Brushes", "Hair Dryers", "Straighteners", "Mirrors", "Tweezers"]},
            {"name": "Vitamiinnada & Kabayaasha (Vitamins & Supplements)", "subs": ["Multivitamins", "Protein Supplements", "Herbal Remedies", "Weight Management"]},
            {"name": "Masaajida (Massagers)", "subs": ["Body Massagers", "Face Massagers", "Electric Massagers", "Massage Oils"]},
            {"name": "Adeegyada Qurxinta (Health & Beauty Services)", "subs": ["Salon", "Spa & Massage", "Nail Care", "Makeup Artist", "Barber"]},
        ],
    },
    {
