        ...
        <div className="bg-white border border-slate-200 dark:border-neutral-800 rounded-2xl p-6 mb-8">
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 border border-slate-200 dark:border-neutral-800 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-[#6cd4ff]"
            />
            <textarea
              ...
              {campaigns.length === 0 ? (
                ...
                campaigns.map((campaign, idx) => (
                  <tr key={idx} className="border-b border-slate-200 dark:border-neutral-800 hover:bg-slate-50 dark:bg-neutral-900/40">
                    ...
                    <td className="px-6 py-4 text-slate-600 dark:text-neutral-200">{campaign.sent_count || 0}</td>
                    <td className="px-6 py-4 text-slate-600 dark:text-neutral-200">{campaign.open_count || 0}</td>
